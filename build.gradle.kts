...
plugins {
    ...
    // Entferne Kotlin-Plugins, da sie nicht benötigt werden (Projekt ist Java-basiert)
    // kotlin("jvm") version "2.0.20"  // Für Kotlin-Support, falls benötigt; ansonsten entfernen
